...
o At least one data type validation.
...
frontend:
- need update actions on bunny and paths 
- need delete action on path 
- need create and delete actions on walks
    - select bunnies you see + 1 on counter 
    - +1 counter for bunies you dont have logged 
    - create bunny on bottom of screen in case a new type is found 
